...
class Colors {
  ...
  Color _accentColor = Color(0xFFFFFFFF);
  Color _accentDarkColor = Color(0xFFADC4C8);
  Color _bgColor = Color(0xFFFAFAFA);
  Color _filterBarColor = Color(0xFF86754E);
  ...
  Color bgColor(double opacity) {
    return this._bgColor.withOpacity(opacity);
  }

  Color filterBarColor(double opacity) {
    return this._filterBarColor.withOpacity(opacity);
  }
}